...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Tridentlayers Core tridentlayers-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tridentlayers-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tridentlayers transaction") + "\n" +
              "  tridentlayers-tx [options] -create [commands]   " + _("Create hex-encoded tridentlayers transaction") + "\n" +
              "\n";
